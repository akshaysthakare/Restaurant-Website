...
const VerifyEmail = () => {
  ...
  const handleChange = (index: number, value: string) => {
    ...
    //Move to the next input field id if a digit is entered
    if (value !== "" && index < 5) {
  ...
  //delete the element when we press backspace
  ...
  return (
    <div className="flex items-center justify-center h-screen w-full">
      <div className="p-8 border border-gray-200 rounded-md w-full max-w-md flex flex-col gap-10">
        ...
        <form action="">
          ...
          {
            loading ? <Button disabled className="bg-orange hover:hoverOrange mt-6 w-full">
              <Loader2 className="mr-2 w-4 h-4 animate-spin" />
              Please Wait
            </Button> :
              (<Button className="bg-orange hover:hoverOrange mt-6 w-full">Verify</Button>)
          }
